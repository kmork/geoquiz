...
Advancing to the next city requires more than choosing the right destination. The player needs enough evidence on the board: route evidence, cultural-pattern evidence, and confirmation/contradiction evidence. Once the destination is ready, traveling there advances the case directly; the evidence review happens in the atlas inspection panel and on the board rather than in a separate overlay. This keeps the mode slower and more detective-like than the chase modes without interrupting the map flow.
