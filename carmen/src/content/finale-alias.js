export const FINALE_ALIAS = {
  name: 'Belladonna Vane',
  hair: 'black',
  accessory: 'red trench coat',
  hobby: 'tango dancing',
  vehicle: 'red convertible',
  origin: 'Origin disputed; latest papers place her in Montevideo.',
