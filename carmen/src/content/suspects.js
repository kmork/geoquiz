...
export const SUSPECTS = [
  ...
  { name: 'Carmen Sandiego', hair: 'black', accessory: 'red trench coat', hobby: 'tango dancing', vehicle: 'red convertible',
    ...
    quirk: 'Cannot resist correcting geography mistakes', img: '' },
  ...
  { name: 'Phantom Fox', hair: 'silver', accessory: 'fox brooch', hobby: 'origami', vehicle: 'hang glider',
    ...
    quirk: 'Leaves an origami fox at the scene', img: 'carmen/img/Phantom Fox.png' },
  ...
  { name: 'Scarlet Cipher', hair: 'red', accessory: 'coded tattoo', hobby: 'cryptography', vehicle: 'sports car',
    ...
    quirk: 'Encrypts ransom notes in geographic coordinates', img: 'carmen/img/Scarlet Cipher.png' },
  ...
  { name: 'Raven Noir', hair: 'black', accessory: 'feathered hat', hobby: 'bird watching', vehicle: 'balloon',
    ...
    quirk: 'Communicates through bird calls', img: 'carmen/img/Raven Noir.png' },
  ...
  { name: 'Count Obsidian', hair: 'black', accessory: 'obsidian ring', hobby: 'antiquities', vehicle: 'helicopter',
    ...
    quirk: 'Collects volcanic glass from eruption sites', img: 'carmen/img/Count Obsidian.png' },
  { name: 'Ivy Virelli', hair: 'green', accessory: 'vine bracelet', hobby: 'botany', vehicle: 'bicycle',
    ...
    quirk: 'Grows rare plants in hidden greenhouses worldwide', img: 'carmen/img/Ivy Virelli.png' },
  { name: 'Echo', hair: 'unknown', accessory: 'voice modulator', hobby: 'sound engineering', vehicle: 'drone',
    ...
    quirk: 'Identity completely unknown; communicates only through distorted audio', img: 'carmen/img/Echo.png' },
  { name: 'The Locksmith', hair: 'brown', accessory: 'keychain', hobby: 'lockpicking', vehicle: 'van',
    ...
    quirk: 'Collects antique keys from every country', img: 'carmen/img/The Locksmith.png' },
  ...
  { name: 'Nova Vex', hair: 'red', accessory: 'visor', hobby: 'astronomy', vehicle: 'jet',
    ...
    quirk: 'Names heists after constellations', img: 'carmen/img/Nova Vex.png' },
  { name: 'Saffron Silk', hair: 'auburn', accessory: 'silk fan', hobby: 'tea ceremonies', vehicle: 'rickshaw',
    ...
    quirk: 'Leaves a saffron thread at every scene', img: 'carmen/img/Saffron Silk.png' },
  ...
  { name: 'Crimson Dagger', hair: 'red', accessory: 'dagger', hobby: 'dueling', vehicle: 'motorcycle',
    ...
    quirk: 'Challenges rivals to duels before escaping', img: 'carmen/img/Crimson Dagger.png' },
  { name: 'Golden Lynx', hair: 'blond', accessory: 'necklace', hobby: 'jewelry', vehicle: 'sports car',
    ...
    quirk: 'Only steals gems — never gold', img: 'carmen/img/Golden Lynx.png' },
  { name: 'Ivory Whisper', hair: 'white', accessory: 'gloves', hobby: 'piano', vehicle: 'car',
    ...
    quirk: 'Plays a short piece on any piano found at the scene', img: 'carmen/img/Ivory Whisper.png' },
  { name: 'Neon Specter', hair: 'green', accessory: 'visor', hobby: 'hacking', vehicle: 'motorbike',
    ...
    quirk: 'Hacks digital billboards to taunt investigators', img: 'carmen/img/Neon Specter.png' },
  { name: 'Scarlet Swan', hair: 'red', accessory: 'necklace', hobby: 'ballet', vehicle: 'car',
    ...
    quirk: 'Leaves ballet slippers as a calling card', img: 'carmen/img/Scarlet Swan.png' },
  ...
  { name: 'Midnight Owl', hair: 'black', accessory: 'glasses', hobby: 'reading', vehicle: 'bicycle',
    ...
    quirk: 'Steals only first editions; returns photocopies', img: 'carmen/img/Midnight Owl.png' },
  ...
  { name: 'Silver Comet', hair: 'silver', accessory: 'watch', hobby: 'running', vehicle: 'jet',
    ...
    quirk: 'Outruns any pursuer on foot', img: 'carmen/img/Silver Comet.png' },
  { name: 'Velvet Raven', hair: 'black', accessory: 'cloak', hobby: 'poetry', vehicle: 'boat',
    ...
    quirk: 'Leaves handwritten poems at crime scenes', img: 'carmen/img/Velvet Raven.png' },
  { name: 'Amber Fox', hair: 'auburn', accessory: 'brooch', hobby: 'collecting', vehicle: 'car',
    ...
    quirk: 'Collects amber from every Baltic country', img: 'carmen/img/Amber Fox.png' },
  ...
  { name: 'Storm Herald', hair: 'gray', accessory: 'coat', hobby: 'meteorology', vehicle: 'plane',
    ...
    quirk: 'Strikes only during storms for cover', img: 'carmen/img/Storm Herald.png' },
  { name: 'Crimson Mirage', hair: 'red', accessory: 'scarf', hobby: 'illusion', vehicle: 'train',
    ...
    quirk: 'Creates diversions using mirrors and light', img: 'carmen/img/Crimson Mirage.png' },
  { name: 'Onyx Panther', hair: 'black', accessory: 'mask', hobby: 'stealth', vehicle: 'motorcycle',
    ...
    quirk: 'Has never set off a single alarm', img: 'carmen/img/Onyx Panther.png' },
  ...
  { name: 'Ivory Phantom', hair: 'white', accessory: 'cloak', hobby: 'acting', vehicle: 'car',
    ...
    quirk: 'Masters disguises — changes identity at every border', img: 'carmen/img/Ivory Phantom.png' },
  ...
  { name: 'Emerald Kite', hair: 'green', accessory: 'ring', hobby: 'kite flying', vehicle: 'glider',
    ...
    quirk: 'Uses kites to scout locations from above', img: 'carmen/img/Emerald Kite.png' },
  { name: 'Shadow Lynx', hair: 'black', accessory: 'gloves', hobby: 'tracking', vehicle: 'jeep',
    ...
    quirk: 'Can track any person across any terrain', img: 'carmen/img/Shadow Lynx.png' },
  { name: 'Copper Sparrow', hair: 'auburn', accessory: 'hat', hobby: 'writing', vehicle: 'bicycle',
    ...
    quirk: 'Publishes crime memoirs under a pen name', img: 'carmen/img/Copper Sparrow.png' },
  { name: 'Ghost Mariner', hair: 'gray', accessory: 'compass', hobby: 'sailing', vehicle: 'ship',
    ...
    quirk: 'Ship appears and vanishes like a phantom in fog', img: 'carmen/img/Ghost Mariner.png' },
