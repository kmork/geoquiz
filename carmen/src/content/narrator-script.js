...
const CASE_CUES = {
  ...
  2: [
    [0.0,  "Closed one case.\nDidn't feel closed."],
    [3.0,  "They rarely do."],
    [5.0,  "I was halfway through bad coffee\nwhen the next file landed."],
    [9.0,  "Still warm."],
    [10.5, "Funny thing\u2014coffee always\ntastes worse when it's accurate."],
  ],
  3: [
    [0.0,  "Different job. Same shape."],
    [2.5,  "You start noticing that\nafter a while."],
    [5.5,  "I told myself\nit was coincidence."],
    [9.0,  "I've told myself worse."],
    [12.0, "If this were a movie,\nthis is where it gets complicated."],
  ],
  4: [
    [0.0,  "Someone mentioned a name\nthis time."],
    [2.5,  "Quiet. Like it might break\nif they said it louder."],
    [5.5,  "I didn't ask them\nto repeat it."],
  ...
  7: [
    ...
    [3.5,  "That's new."],
    [5.5,  "I was thinking about that\u2026"],
    [8.5,  "When the next file showed up\nlike it had somewhere to be."],
    [13.0, "I don't like paperwork\nwith urgency."],
  ],
  8: [
    [0.0,  "I got close.\nClose enough to feel it."],
    [3.0,  "Witness said they saw her.\nMaybe."],
    [6.0,  "Red coat.\nGone before it mattered."],
    [9.5,  "That's how legends\nstay legends."],
    [12.5, "Also how they\nstay employed."],
  ],
  9: [
    [0.0,  "This last one\nfelt too clean."],
    [3.0,  "I don't trust clean.\nNever have."],
